...
const options = {loose: 'all', optional: ['runtime']},
 ...
 * });
 */
export default function jsNodeCompileFile(scriptFile: string, callback: Function) {
  transformFile(scriptFile, options, function (e, result) {
    if (e) {
      return callback(e);
    }
