...
var UglifyJsPlugin = optimize.UglifyJsPlugin;
var productionPlugins = [new DefinePlugin({ 'process.env': { NODE_ENV: (0, _stringify2.default)('production') } }), new OccurrenceOrderPlugin(), new DedupePlugin(), new UglifyJsPlugin({ compress: { warnings: false } })];
...
var JSCompiler = exports.JSCompiler = function (_Compiler) {
  ...
  function JSCompiler() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, _Compiler.call(this, compress));
  ...
  JSCompiler.prototype.configure = function configure(options) {
  ...
  JSCompiler.prototype.beDir = function beDir(inPath, outPath, callback) {
    var _this2 = this;
  ...
  JSCompiler.prototype.beFile = function beFile(inPath, outPath, callback) {
    ++this.processing;
  ...
  JSCompiler.prototype.copyFile = function copyFile(inPath, outPath, callback) {
    ++this.processing;
  ...
  JSCompiler.prototype.beTraverse = function beTraverse(inPath, outPath, callback) {
    var _this3 = this;
  ...
  JSCompiler.prototype.be = function be(inPath, outPath) {
    var _this4 = this;
  ...
  JSCompiler.prototype.fe = function fe(inPath, outPath) {
    var _this5 = this;

    var callback = arguments.length <= 2 || arguments[2] === undefined ? _noop2.default : arguments[2];
    var _options = this.options;
    var presets = _options.presets;
    var options = (0, _objectWithoutProperties3.default)(_options, ['presets']);
      ...
      module: {
        loaders: [{
          ...
          query: (0, _extends3.default)({
            cacheDirectory: true,
            presets: (0, _map2.default)(presets, function (preset) {
              if ('es2015' === preset) {
                return ['es2015', { modules: false }];
              }
              if ((0, _isArray2.default)(preset) && 'es2015' === preset[0]) {
                return ['es2015', (0, _extends3.default)({}, preset[1], { modules: false })];
              }
