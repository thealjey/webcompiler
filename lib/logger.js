...
exports.consoleStyles = exports.Message = undefined;
exports.formatLine = formatLine;
exports.formatErrorMarker = formatErrorMarker;
exports.log = log;
exports.logError = logError;
exports.logPostCSSWarnings = logPostCSSWarnings;
exports.logSASSError = logSASSError;
exports.logLintingErrors = logLintingErrors;
exports.logSequentialSuccessMessage = logSequentialSuccessMessage;
...
class Message {
   ...
   */
  addFEMessageInstance(msg) {
    const { css } = this.style;

    this.message += msg.message;
    this.styles.push(...(0, _map2.default)(msg.styles, style => `${style}${css}`));
  }
  ...
  addMessages(messages) {
    (0, _forEach2.default)(messages, message => this.addMessage(message));
...
const consoleStyles = exports.consoleStyles = (0, _transform2.default)({
 ...
 */
function formatLine(message, file, line, column) {
 ...
 * @return {module:logger.Message} a styled message
 */
function formatErrorMarker(message = 'Error') {
...
function logError(error) {
  ...
  error.stack = (0, _cleanStack2.default)(stack);

  (0, _forEach2.default)(_errorStackParser2.default.parse(error), ({ functionName = 'unknown', fileName, lineNumber, columnNumber }) => {
 ...
 */
function logSequentialSuccessMessage(message) {
