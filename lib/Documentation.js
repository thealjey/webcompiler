...
var Documentation = exports.Documentation = function () {
  ...
  Documentation.findExecutable = function findExecutable(callback) {
  ...
  Documentation.checkBin = function checkBin(callback) {
  ...
  Documentation.prototype.run = function run() {
    var _this = this;
  ...
  Documentation.prototype.doRun = function doRun(jsdoc, callback) {
