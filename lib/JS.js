...
var JS = exports.JS = function () {
  ...
  JS.prototype.typecheck = function typecheck(callback) {
    var _this = this;
  ...
  JS.prototype.lint = function lint(paths, callback) {
  ...
  JS.prototype.validate = function validate(inPath, lintPaths, callback) {
    var _this2 = this;
  ...
  JS.prototype.be = function be(inPath, outPath) {
    var _this3 = this;
  ...
  JS.prototype.fe = function fe(inPath, outPath) {
    var _this4 = this;
