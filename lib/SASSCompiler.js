...
var SASSCompiler = exports.SASSCompiler = function (_Compiler) {
  ...
  SASSCompiler.autoprefix = function autoprefix(path, data, callback) {
  ...
  SASSCompiler.prototype.fe = function fe(inPath, outPath) {
    var _this2 = this;
    ...
    (0, _nodeSass.render)({
      ...
      SASSCompiler.autoprefix(outPath, { code: result.css, map: result.map.toString() }, function (data) {
        _this2.save(inPath, outPath, data, callback);
      });
    });
  };
